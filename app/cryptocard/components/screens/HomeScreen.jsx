...
import { CreditCard, FileText, Headphones, ShieldCheck, Globe, Zap, Gift, Wallet, Lock, Bot, Link, CheckCircle } from 'lucide-react';
    ...
    <div className={`${s.screen} ${active ? s.active : ''} ${flashing ? s['screen-flash'] : ''}`}>
      ...
      <div className={s['bal-hero']}>
        ...
        <div className={s['bh-cols']}>
          <div className={s['bh-col']}>
            <div className={s['bc-dot']} style={{ background: 'var(--bnb)' }} />
            <div className={s['bc-lbl']}>{t.walletLbl}</div>
            <div className={s['bc-val']}>{hWallet}</div>
            <div className={s['bc-tag']} style={hWTagStyle}>{hWTag}</div>
          </div>
          <div className={s['bh-col']}>
            <div className={s['bc-dot']} style={{ background: 'var(--green)' }} />
            <div className={s['bc-lbl']}>{t.voucherLbl}</div>
            <div className={s['bc-val']} style={{ color: 'var(--green)' }}>{hVouch}</div>
            <div className={s['bc-tag']} style={hVTagStyle}>{hVTag}</div>
          </div>
          <div className={s['bh-col']}>
            <div className={s['bc-dot']} style={{ background: '#60a5fa' }} />
            <div className={s['bc-lbl']}>{t.rewardsLbl}</div>
            <div className={s['bc-val']} style={{ color: '#60a5fa' }}>0 USDT</div>
            <div className={s['bc-tag']} style={{ background: 'var(--bluebg)', color: '#60a5fa' }}>{t.tagCashback}</div>
          </div>
        </div>
      </div>
